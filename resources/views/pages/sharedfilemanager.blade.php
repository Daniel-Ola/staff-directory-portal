    ...
    <div class="content">
        ...
        <div class="row invisible mt-5 pt-5" data-toggle="appear">
            ...
            <table class="table table-striped table-borderless table-hover table-vcenter">
                ...
                <tbody>
                    @forelse ($sharedDocs as $k => $folder)
                        <tr>
                            <td class="d-none d-sm-table-cell text-center">
                                <span class="badge badge-pill badge-primary">{{ $k+1 }}</span>
                            </td>
                            <td class="text-center">
                                <i class="fa fa-folder text-primary" style="font-size: 22px;"></i>
                            </td>
                            <td class="font-w600">
                                <a href="{{ route('shared.folders', [$folder->slug]) }}">{{ $folder->name }}</a>
                            </td>
                            <td class="d-none d-sm-table-cell">
                                @php
                                    $creator = \App\User::find($folder->user_id);
                                @endphp
                                {{ $creator->firstname. ' ' .$creator->lastname }}
                            </td>
                            <td class="d-none d-lg-table-cell">
                                <span class="">{{ $folder->created_on }}</span>
                            </td>
                            <td class="text-center">
                    ...
                    @empty
                        @if (Request::segment(2))
                            <tr><td colspan="6"><strong>There are no folders in this directory</strong> </td></tr>
                        @endif
                        {{-- @if (Request::segment(2))
